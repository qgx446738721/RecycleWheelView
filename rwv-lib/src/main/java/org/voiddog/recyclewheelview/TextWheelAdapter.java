package org.voiddog.recyclewheelview;
 ...
 */
public class TextWheelAdapter<T> extends RecyclerView.Adapter<TextWheelAdapter.MyViewHolder>{
    List<T> mTextList;
    //字体颜色
    int mTextColor;
    //字体padding
    ...
    @Override
    public void onBindViewHolder(TextWheelAdapter.MyViewHolder holder, int position) {
